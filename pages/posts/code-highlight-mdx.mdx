...
<Box borderWidth="2px" borderColor="#13233A">
# Hello, *world*!
...
Temos um `<CodeBlock />` "atribuído" ao componente `code`, código completo [CodeBlock](https://github.com/Bastiani/bastiani-blog-mdx/blob/master/components/CodeBlock.tsx):
...
![](https://www.rafaelbastiani.com/static/posts/code-into-mdx.png)
