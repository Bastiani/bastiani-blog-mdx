...
<NextSeo
  ...
  openGraph={{
    ...
    title: 'Inserindo syntax highlight dentro de um mdx',
    description: 'Vamos ver como inserir syntax highlight dentro de um conteudo em mdx',
    images: [{ url: 'https://www.rafaelbastiani.com/static/posts/syntax-highlight-mdx.png' }],
...
<BlogJsonLd
  ...
  images={['https://www.rafaelbastiani.com/static/posts/syntax-highlight-mdx.png']}
